    ...
    implements Parcelable, ParcelWrapper<com.akexorcist.googledirection.model.Route>
{
    ...
    private void writecom_akexorcist_googledirection_model_Leg(com.akexorcist.googledirection.model.Leg leg$$3, android.os.Parcel parcel$$20, int flags$$3) {
        ...
        if (leg$$3 .durationInTraffic == null) {
            ...
            parcel$$20 .writeInt(1);
            writecom_akexorcist_googledirection_model_Info(leg$$3 .durationInTraffic, parcel$$20, flags$$3);
        }
    ...
    private void writecom_akexorcist_googledirection_model_Info(com.akexorcist.googledirection.model.Info info$$6, android.os.Parcel parcel$$22, int flags$$5) {
        parcel$$22 .writeString(info$$6 .text);
        parcel$$22 .writeString(info$$6 .value);
    }
